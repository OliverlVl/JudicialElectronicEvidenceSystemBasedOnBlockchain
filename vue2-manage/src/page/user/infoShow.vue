<template>
    <div class="fillcontain">
        ...
        <el-row class="info_row" :gutter="10">
                ...
                <div class="area">
                    <div class="namearea">
                        <p>姓名：王小川</p>
                        <p>昵称：PW68061826</p>
                        <p>绑定邮箱：1040671601@qq.com</p>
                        <p>绑定手机：17859975022</p>
        ...
        <el-row class="data_row row" :gutter="10">
                <el-col :span="6">
                <div class="area">
                    <p class="title"><icon-svg icon-class="iconpay3" />存证使用情况</p> 
                ...
                <el-col :span="6">
                    <div class="area">
                    <p class="title"><icon-svg icon-class="iconpay3" />取证使用情况</p>
                ...
                <el-col :span="6">
                    <div class="area">
                    <p class="title"><icon-svg icon-class="iconpay3" />公证详情</p>
